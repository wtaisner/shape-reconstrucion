...
def main():
    ...
    input_file_folder = '/home/annprzy/Desktop/shape-reconstrucion/data/shape_net_3_classes'
    ...
    mesh_files = glob.glob(input_file_folder + '/*/*/*/*.obj')
    ...
    for m_file in mesh_files:
        ...
        rc = subprocess.call(['/home/annprzy/binvox', '-d', str(N_VOX), '-e', '-cb', '-rotx', '-rotx', '-rotx', '-rotz', m_file])
        if not rc == 0:
