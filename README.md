...
2. We created the following dataset: sampled 50% of the already possessed voxel grids of size 32. Moreover, we took 21 small categories from the original ShapeNet, downsampled voxel grids from 128 to 32.
